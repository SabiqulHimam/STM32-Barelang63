...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13|Dir1_Pin|Mode1_Pin|GPIO_PIN_9, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, En2A_Pin|En2B_Pin|Dir2_Pin|Mode2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : bat_Pin Enc2B_Pin */
  GPIO_InitStruct.Pin = bat_Pin|Enc2B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PB13 Dir1_Pin Mode1_Pin PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_13|Dir1_Pin|Mode1_Pin|GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
